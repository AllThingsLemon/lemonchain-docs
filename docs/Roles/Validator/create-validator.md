...
```shell
cd ~/go-opera/build/
wget https://docs.toruschain.com/genesis-files/mainnet/genesis-lemon.g
...
Navigate to [stake.toruschain.com](https://stake.toruschain.com/). Once you're there, connect your wallet.
...
`https://toruscan.com/tx/{YOUR_TX_HASH}`
