...
You can authenticate your contracts using a Hardhat or Truffle command line. First, obtain a scan API Key from https://toruscan.com/. If you don't have an account, register first, and then generate a scan API Key. Hover over your username and select 'API Keys'. You can then create an API Key.
